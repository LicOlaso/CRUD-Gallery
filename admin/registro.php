                ...
                <div class="row g-0">
                  ...
                  <div class="col-sm-6 col-xs-12 "style="display: flex; align-items: center;">
                    ...
                    <div class="card-body" >
                      ...
                      <form action="actions/registro.act.php" method="" class="form m-3">
                                      <div class="form-group row">
                                          <label for="display_name" class="col-xs-12  col-form-label text-md-right">Nombre</label>
                                          <div class="col-xs-12">
                                              <input type="text" id="display_name" class="form-control" name="display_name" required autofocus>
                                          </div>
                                      </div>
                                      <div class="form-group row">
